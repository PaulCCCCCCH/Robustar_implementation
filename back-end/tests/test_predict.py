...
class TestPredict:
    class TestPredict:
        ...
        def test_predict_success(self, client):
            ...
            assert data[2] == [f"{RServer.getServer().baseDir}/generated/visualize_images/{to_snake_path(RServer.getServer().baseDir)}_dataset_train_bird_1_JPEG_{idx}.png" for idx in range(4)]
            # TODO: [test] other splits
