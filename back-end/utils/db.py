def get_init_schema_str():
    return """
--
-- File generated with SQLiteStudio v3.3.3 on Sat Jul 2 15:48:57 2022
--
...
-- Table: influ_rel
CREATE TABLE influ_rel (path VARCHAR (256) NOT NULL, source_path VARCHAR (256) NOT NULL, "order" INTEGER NOT NULL, PRIMARY KEY (path, source_path));
